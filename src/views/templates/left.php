<aside class="sidebar">
    <nav class="menu mt-3">
        <ul class="nav-list">
            <li class="nav-item">
                <a href="day_recordsController.php">
                    <i class="icofont-ui-check mr-2"></i>
                    Registrar Ponto
                </a>
            </li>
            <li class="nav-item">
                <a href="monthly_reportController.php">
            ...
            <?php if($user->is_admin) : ?>
                <li class="nav-item">
                    <a href="manager_reportController.php">
    ...
    <div class="sidebar-widgets">
        <div class="sidebar-widget">
            ...
            <div class="info">
                <!-- '$activeClock' informa pro JS quem estará com a propriedade 'activeClock' -->
